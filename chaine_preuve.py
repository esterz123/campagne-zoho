...
def main():
    ...
    if rc != 0:
        return 1
    run(["chasseur_noms.py"], "2bis NOMS REELS DES DIRIGEANTS (API Etat, verifie)")
    run(["generateur_rapports.py"], "2ter RAPPORTS DOCX PRE-GENERES (promesse 'deja fait' = vraie)")
